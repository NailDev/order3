!(function (e, t) {
  ...
  function A(e, t) {
    ...
    const l = (function (e) {
      ...
      return (s =
        (s =
          !(s = t.getComputedStyle ? t.getComputedStyle(e, null) : s) &&
          e.currentStyle
            ? e.currentStyle
            : s) || e.style);
    })(e);
  ...
  function f(s, a) {
    a &&
      s.addEventListener("transitionend", function e(t) {
        t.target === s &&
          (a.call(s, t), s.removeEventListener("transitionend", e));
      });
  }
  function H(e, t, s) {
    const a = z();
      ...
      if (a && !a.destroyed && a.params) {
        ...
        if (i && s && !(s < 0)) {
          ...
          if (a.params.grid && 1 < a.params.grid.rows) {
            const i = l,
              n = [i - s];
            n.push(...Array.from({ length: s }).map((e, t) => i + r + t)),
            ...
            if (a.params.rewind || a.params.loop)
              for (let t = l - s; t <= n + s; t += 1) {
                const e = ((t % i) + i) % i;
                (e < l || e > n) && o(a, e);
              }
            else
              for (
                let e = Math.max(l - s, 0);
                e <= Math.min(n + s, i - 1);
                e += 1
              )
                e !== l && (e > n || e < l) && o(a, e);
  ...
  const l = {
          ...
          if (i.eventsListeners && !i.destroyed && i.eventsListeners) {
            ...
            (a =
              "string" == typeof r[0] || Array.isArray(r[0])
                ? ((e = r[0]), (s = r.slice(1, r.length)), i)
                : ((e = r[0].events), (s = r[0].data), r[0].context || i)),
              s.unshift(a),
      ...
      update: {
        updateSize: function () {
          ...
          (t =
            ...
            (0 === t && e.isHorizontal()) ||
              ...
              ((t =
                t -
                parseInt(D(a, "padding-left") || 0, 10) -
                parseInt(D(a, "padding-right") || 0, 10)),
              (s =
                s -
                parseInt(D(a, "padding-top") || 0, 10) -
                parseInt(D(a, "padding-bottom") || 0, 10)),
              Number.isNaN(t) && (t = 0),
              Number.isNaN(s) && (s = 0),
              Object.assign(e, {
                width: t,
        ...
        updateSlides: function () {
          ...
          const l = a.params,
            ...
            t = a.virtual && l.virtual.enabled,
            c = (t ? a.virtual : a).slides.length,
            u = I(e, `.${a.params.slideClass}, swiper-slide`),
            m = (t ? a.virtual.slides : u).length;
          let h = [];
          const f = [],
            v = [];
          let g = l.slidesOffsetBefore,
            w =
              ("function" == typeof g && (g = l.slidesOffsetBefore.call(a)),
              l.slidesOffsetAfter);
          "function" == typeof w && (w = l.slidesOffsetAfter.call(a));
          var b = a.snapGrid.length,
            y = a.slidesGrid.length;
          let E = l.spaceBetween,
            x = -g,
            S = 0,
            T = 0;
          if (void 0 !== o) {
            ...
            var M = l.grid && 1 < l.grid.rows && a.grid;
            let s;
            M && a.grid.initSlides(m);
            var C =
              "auto" === l.slidesPerView &&
              l.breakpoints &&
              0 <
                Object.keys(l.breakpoints).filter(
                  (e) => void 0 !== l.breakpoints[e].slidesPerView
                ).length;
            for (let t = 0; t < m; t += 1) {
              let e;
              if (
                ((s = 0),
                u[t] && (e = u[t]),
                M && a.grid.updateSlide(t, e, m, i),
                !u[t] || "none" !== D(e, "display"))
              ) {
                if ("auto" === l.slidesPerView) {
                  ...
                  if (
                    ...
                    if (p && "border-box" === p) s = a + n + d;
                    else {
                      const { clientWidth: r, offsetWidth: o } = e;
                      s = a + i + l + n + d + (o - r);
                    }
                  }
                  d && (e.style.transform = d),
                    p && (e.style.webkitTransform = p),
                    l.roundLengths && (s = Math.floor(s));
                } else
                  (s = (o - (l.slidesPerView - 1) * E) / l.slidesPerView),
                    l.roundLengths && (s = Math.floor(s)),
                    u[t] && (u[t].style[i("width")] = s + "px");
                u[t] && (u[t].swiperSlideSize = s),
                  v.push(s),
                  l.centeredSlides
                    ? ((x = x + s / 2 + S / 2 + E),
                      0 === S && 0 !== t && (x = x - o / 2 - E),
            ...
            if (
              ((a.virtualSize = Math.max(a.virtualSize, o) + w),
              d &&
                p &&
                ("slide" === l.effect || "coverflow" === l.effect) &&
                (n.style.width = a.virtualSize + E + "px"),
              l.setWrapperSize &&
                (n.style[i("width")] = a.virtualSize + E + "px"),
              M && a.grid.updateWrapperSize(s, h, i),
              !l.centeredSlides)
            ) {
              const i = [];
              for (let t = 0; t < h.length; t += 1) {
                ...
                l.roundLengths && (e = Math.floor(e)),
                  h[t] <= a.virtualSize - o && i.push(e);
              }
              (h = i),
                1 <
                  Math.floor(a.virtualSize - o) - Math.floor(h[h.length - 1]) &&
                  h.push(a.virtualSize - o);
            }
            if (t && l.loop) {
              const i = v[0] + E;
              ...
              for (
                ...
                1 === l.slidesPerGroup && h.push(h[h.length - 1] + i),
                  f.push(f[f.length - 1] + i),
                  (a.virtualSize += i);
            }
            if ((0 === h.length && (h = [0]), 0 !== E)) {
              const r = a.isHorizontal() && d ? "marginLeft" : i("marginRight");
              u.filter(
                (e, t) => !(l.cssMode && !l.loop) || t !== u.length - 1
              ).forEach((e) => {
                e.style[r] = E + "px";
              });
            }
            ...
            if (
              ...
              P(n, "--swiper-centered-offset-before", -h[0] + "px"),
                P(
                  ...
                  a.size / 2 - v[v.length - 1] / 2 + "px"
                );
              const i = -a.snapGrid[0],
                r = -a.slidesGrid[0];
              (a.snapGrid = a.snapGrid.map((e) => e + i)),
                (a.slidesGrid = a.slidesGrid.map((e) => e + r));
            }
            if (
              (m !== c && a.emit("slidesLengthChange"),
              h.length !== b &&
                (a.params.watchOverflow && a.checkOverflow(),
                a.emit("snapGridLengthChange")),
              f.length !== y && a.emit("slidesGridLengthChange"),
              l.watchSlidesProgress && a.updateSlidesOffset(),
              !(
                t ||
                l.cssMode ||
                ("slide" !== l.effect && "fade" !== l.effect)
              ))
            ) {
              const i = l.containerModifierClass + "backface-hidden",
                r = a.el.classList.contains(i);
              m <= l.maxBackfaceHiddenSlides
                ? r || a.el.classList.add(i)
                : r && a.el.classList.remove(i);
            }
          }
        },
        ...
        updateSlidesOffset: function () {
          ...
          for (let e = 0; e < s.length; e += 1)
            s[e].swiperSlideOffset =
              (t.isHorizontal() ? s[e].offsetLeft : s[e].offsetTop) -
              a -
        ...
        updateSlidesProgress: function (e) {
          ...
          if (0 !== l.length) {
            ...
            for (let t = 0; t < l.length; t += 1) {
              ...
              var d =
                  (s + (r.centeredSlides ? i.minTranslate() : 0) - e) /
                  (m.swiperSlideSize + a),
                p =
                  (s - o[0] + (r.centeredSlides ? i.minTranslate() : 0) - e) /
                  (m.swiperSlideSize + a),
                c = -(s - e),
        ...
        updateSlidesClasses: function () {
          const t = this,
            { slides: s, params: a, slidesEl: i, activeIndex: r } = t,
            e = t.virtual && a.virtual.enabled,
            l = (e) => I(i, `.${a.slideClass}${e}, swiper-slide` + e)[0];
          let n;
          if (
            (s.forEach((e) => {
              e.classList.remove(
            ...
            } else n = l(`[data-swiper-slide-index="${r}"]`);
          else n = s[r];
          if (n) {
            n.classList.add(a.slideActiveClass);
            let e = (function (e, t) {
                const s = [];
                ...
                return s;
              })(n, `.${a.slideClass}, swiper-slide`)[0],
              t =
                ((e = a.loop && !e ? s[0] : e) &&
                  e.classList.add(a.slideNextClass),
                (function (e, t) {
                  const s = [];
            ...
            (t = a.loop && 0 === !t ? s[s.length - 1] : t) &&
              t.classList.add(a.slidePrevClass);
          }
          t.emitSlidesClasses();
        },
              ...
              (d = (function (e) {
                ...
                for (let e = 0; e < t.length; e += 1)
                  void 0 !== t[e + 1]
                    ...
                    : a >= t[e] && (i = e);
                return (i =
                  s.normalizeSlideIndex && (i < 0 || void 0 === i) ? 0 : i);
              })(s)),
            0 <= a.indexOf(t))
          )
            o = a.indexOf(t);
            ...
            d === r
              ? (o !== n && ((s.snapIndex = o), s.emit("snapIndexChange")),
                s.params.loop &&
                  ...
                  (s.realIndex = e(d)))
              : ((e =
                  s.virtual && i.virtual.enabled && i.loop
                    ? e(d)
                    : s.slides[d]
                    ? parseInt(
                        s.slides[d].getAttribute("data-swiper-slide-index") ||
                          d,
                        10
                      )
                    : d),
      ...
      slide: {
          ...
          if (n.cssMode) {
            ...
            if (0 === t) {
              ...
              t &&
                ...
                t && !r._cssModeVirtualInitialSet && 0 < r.params.initialSlide
        ...
        slideNext: function (e, t, s) {
          ...
          var i = a.activeIndex < r.slidesPerGroupSkip ? 1 : n,
          ...
          return r.rewind && a.isEnd
            ? a.slideTo(0, e, t, s)
            : a.slideTo(a.activeIndex + i, e, t, s);
        },
        slidePrev: function (e, t, s) {
          ...
          if (!o) return a;
          var p = a.virtual && i.virtual.enabled;
          if (i.loop) {
          ...
          const u = c(n ? a.translate : -a.translate),
            m = r.map((e) => c(e));
          ...
          if (
            (void 0 !== h &&
              ((f = l.indexOf(h)) < 0 && (f = a.activeIndex - 1),
            ...
            ? e.animating ||
              ...
              t.centeredSlides
                ? r < e.loopedSlides - a / 2 ||
                  ...
                  ? (e.loopFix(),
                    (r = e.getSlideIndex(
                      I(s, l + `[data-swiper-slide-index="${i}"]`)[0]
                    )),
                    T(() => {
                      e.slideTo(r);
                    }))
      ...
      loop: {
        loopCreate: function (e) {
          var { params: t, slidesEl: s } = this;
          !t.loop ||
            (this.virtual && this.params.virtual.enabled) ||
            (I(s, `.${t.slideClass}, swiper-slide`).forEach((e, t) => {
        ...
        loopFix: function (i) {
          ...
          if (u.params.loop) {
            ...
            if (
              ((u.allowSlidePrev = !0),
              (u.allowSlideNext = !0),
              u.virtual && w.virtual.enabled)
            )
              l &&
                (w.centeredSlides || 0 !== u.snapIndex
                  ? w.centeredSlides && u.snapIndex < w.slidesPerView
                    ? u.slideTo(
              ...
              i =
                "auto" === w.slidesPerView
                  ? u.slidesPerViewDynamic()
                  : Math.ceil(parseFloat(w.slidesPerView, 10));
              let t = w.loopedSlides || i;
              t % w.slidesPerGroup != 0 &&
                (t += w.slidesPerGroup - (t % w.slidesPerGroup)),
                (u.loopedSlides = t);
              const b = [],
                y = [];
              let e = u.activeIndex;
              void 0 === d
                ? (d = u.getSlideIndex(
                    u.slides.filter((e) =>
                      e.classList.contains(w.slideActiveClass)
                    )[0]
                  ))
                : (e = d);
              var i = "next" === n || !n,
              ...
              let s = 0,
                a = 0;
              if (d < t) {
                s = Math.max(t - d, w.slidesPerGroup);
                for (let e = 0; e < t - d; e += 1) {
                  const r = e - Math.floor(e / h.length) * h.length;
                  b.push(h.length - r - 1);
                }
              } else if (d > u.slides.length - 2 * t) {
                a = Math.max(d - (u.slides.length - 2 * t), w.slidesPerGroup);
                for (let e = 0; e < a; e += 1) {
                  const r = e - Math.floor(e / h.length) * h.length;
                  y.push(r);
                }
              ...
              if (
                ...
                u.recalcSlides(),
                "auto" === w.slidesPerView && u.updateSlides(),
                w.watchSlidesProgress && u.updateSlidesOffset(),
                l)
              )
                if (0 < b.length && m)
                  if (void 0 === r) {
                    const i = u.slidesGrid[e],
                      r = u.slidesGrid[e + s] - i;
                    c
                      ...
                      : (u.slideTo(e + s, 0, !1, !0),
                        o &&
                          (u.touches[u.isHorizontal() ? "startX" : "startY"] +=
                            r));
                  } else o && u.slideToLoop(r, 0, !1, !0);
                else if (0 < y.length && i)
                  if (void 0 === r) {
                    const i = u.slidesGrid[e],
                      r = u.slidesGrid[e - a] - i;
                    c
                      ? u.setTranslate(u.translate - r)
                      : (u.slideTo(e - a, 0, !1, !0),
                        o &&
              ...
              if (
                ...
                Array.isArray(u.controller.control)
                  ...
                  : u.controller.control instanceof u.constructor &&
                    ...
                    u.controller.control.loopFix(i);
              }
            }
            u.emit("loopFix");
          }
        ...
        attachEvents: function () {
          ...
          (e.onTouchStart = function (a) {
            const i = this,
              ...
              l = z(),
              n = i.touchEventsData,
              { params: o, touches: d, enabled: e } = (n.evCache.push(a), i);
            if (
              e &&
              (o.simulateTouch || "mouse" !== a.pointerType) &&
              (!i.animating || !o.preventInteractionOnTransition)
            ) {
              !i.animating && o.cssMode && o.loop && i.loopFix();
              let t = a,
                s = (t = t.originalEvent ? t.originalEvent : t).target;
              if (
                ("wrapper" !== o.touchEventsTarget ||
                  i.wrapperEl.contains(s)) &&
                !(
                  ("which" in t && 3 === t.which) ||
                ...
                var p = !!o.noSwipingClass && "" !== o.noSwipingClass,
                  ...
                  p =
                    (p && t.target && t.target.shadowRoot && c && (s = c[0]),
                ...
                if (
                  ...
                  i.allowClick = !0;
                else if (!o.swipeHandler || s.closest(o.swipeHandler)) {
                  (d.currentX = t.pageX), (d.currentY = t.pageY);
                  var c = d.currentX,
                    p = d.currentY,
                  ...
                  s.matches(n.focusableElements) &&
                    ((e = !1), "SELECT" === s.nodeName && (n.isTouched = !1)),
                    r.activeElement &&
                      r.activeElement.matches(n.focusableElements) &&
                      r.activeElement !== s &&
                      r.activeElement.blur();
                  m = e && i.allowTouchMove && o.touchStartPreventDefault;
            ...
            (e.onTouchMove = function (l) {
              ...
              if (t && (d.simulateTouch || "mouse" !== l.pointerType)) {
                let r = l;
                if ((r.originalEvent && (r = r.originalEvent), o.isTouched)) {
                  var l = o.evCache.findIndex(
                      (e) => e.pointerId === r.pointerId
                    ),
                    l =
                      (0 <= l && (o.evCache[l] = r),
                      1 < o.evCache.length ? o.evCache[0] : r),
                    s = l.pageX,
                    l = l.pageY;
                  if (r.preventedByNestedSwiper) (p.startX = s), (p.startY = l);
                  else if (n.allowTouchMove) {
                    if (d.touchReleaseOnEdges && !d.loop)
                      if (n.isVertical()) {
                        if (
                          (l < p.startY && n.translate <= n.maxTranslate()) ||
                          (l > p.startY && n.translate >= n.minTranslate())
                        )
                          return (o.isTouched = !1), void (o.isMoved = !1);
                      } else if (
                        (s < p.startX && n.translate <= n.maxTranslate()) ||
                        (s > p.startX && n.translate >= n.minTranslate())
                      )
                        return;
                    if (
                      e.activeElement &&
                      r.target === e.activeElement &&
                      r.target.matches(o.focusableElements)
                    )
                      (o.isMoved = !0), (n.allowClick = !1);
                    else if (
                      (o.allowTouchCallbacks && n.emit("touchMove", r),
                      !(r.targetTouches && 1 < r.targetTouches.length))
                    ) {
                      (p.currentX = s), (p.currentY = l);
                      var u = p.currentX - p.startX,
                        m = p.currentY - p.startY;
                      if (
                        !(
                          n.params.threshold &&
                          Math.sqrt(u ** 2 + m ** 2) < n.params.threshold
                        )
                      )
                        if (
                          (void 0 === o.isScrolling &&
                            ((n.isHorizontal() && p.currentY === p.startY) ||
                            (n.isVertical() && p.currentX === p.startX)
                              ? (o.isScrolling = !1)
                              : 25 <= u * u + m * m &&
                                ((h =
                                  (180 * Math.atan2(Math.abs(m), Math.abs(u))) /
                                  Math.PI),
                                (o.isScrolling = n.isHorizontal()
                                  ? h > d.touchAngle
                                  : 90 - h > d.touchAngle))),
                          o.isScrolling && n.emit("touchMoveOpposite", r),
                          ...
                          (n.allowClick = !1),
                            !d.cssMode && r.cancelable && r.preventDefault(),
                            d.touchMoveStopPropagation &&
                              !d.nested &&
                              r.stopPropagation();
                          let e = n.isHorizontal() ? u : m,
                            t = n.isHorizontal()
                              ? p.currentX - p.previousX
                              : p.currentY - p.previousY;
                          d.oneWayMovement &&
                            ((e = Math.abs(e) * (c ? 1 : -1)),
                            (t = Math.abs(t) * (c ? 1 : -1))),
                            (p.diff = e),
                  ...
                  o.startMoving &&
                    o.isScrolling &&
                    n.emit("touchMoveOpposite", r);
              }
            }.bind(e)),
            (e.onTouchEnd = function (t) {
              const r = this,
                e = r.touchEventsData,
                s = e.evCache.findIndex((e) => e.pointerId === t.pointerId);
              if (
                (0 <= s && e.evCache.splice(s, 1),
                ...
                if (d && (l.simulateTouch || "mouse" !== t.pointerType)) {
                  let i = t;
                  if (
                    (i.originalEvent && (i = i.originalEvent),
                    e.allowTouchCallbacks && r.emit("touchEnd", i),
                    ...
                    var p,
                      d = g(),
                      c = d - e.touchStartTime;
                    if (r.allowClick) {
                      const t = i.path || (i.composedPath && i.composedPath());
                      r.updateClickedSlide((t && t[0]) || i.target),
                        r.emit("tap click", i),
                        c < 300 &&
                          d - e.lastClickTime < 300 &&
                          ...
                          c > l.longSwipesMs
                            ? l.longSwipes
                              ? ("next" === r.swipeDirection &&
                                  (d >= l.longSwipesRatio
                                    ? r.slideTo(l.rewind && r.isEnd ? e : t + n)
                                    : r.slideTo(t)),
                                "prev" === r.swipeDirection &&
                                  (d > 1 - l.longSwipesRatio
                                    ? r.slideTo(t + n)
                                    : null !== a &&
                                      d < 0 &&
                                      Math.abs(d) > l.longSwipesRatio
                                    ? r.slideTo(a)
                                    : r.slideTo(t)))
                            ...
                            ? !r.navigation ||
                              (i.target !== r.navigation.nextEl &&
                                i.target !== r.navigation.prevEl)
                              ? ("next" === r.swipeDirection &&
                                  r.slideTo(null !== e ? e : t + n),
                                "prev" === r.swipeDirection &&
                                  r.slideTo(null !== a ? a : t))
                              : i.target === r.navigation.nextEl
                              ? r.slideTo(t + n)
                              : r.slideTo(t)
                            : r.slideTo(r.activeIndex);
                    ...
                    e.isMoved && l.grabCursor && r.setGrabCursor(!1),
                      (e.isMoved = !1),
                      (e.startMoving = !1);
                }
              }
            ...
            N || (t.addEventListener("touchstart", q), (N = !0)),
            R(e, "on");
        },
        ...
        setBreakpoint: function () {
          ...
          if (r && 0 !== Object.keys(r).length) {
            ...
            if (l && a.currentBreakpoint !== l) {
              ...
              var n = d.direction && d.direction !== i.direction,
                o = i.loop && (d.slidesPerView !== i.slidesPerView || n),
                n =
                  (n && t && a.changeDirection(),
                  h(a.params, d),
                  a.params.enabled);
              Object.assign(a, {
                ...
                u && !n ? a.disable() : !u && n && a.enable(),
                (a.currentBreakpoint = l),
                a.emit("_beforeBreakpoint", d),
                o && t && (a.loopDestroy(), a.loopCreate(e), a.updateSlides()),
                a.emit("breakpoint", d);
            }
          }
        },
        getBreakpoint: function (e, s, a) {
          if ((void 0 === s && (s = "window"), e && ("container" !== s || a))) {
            ...
            for (let e = 0; e < l.length; e += 1) {
              const { point: z, value: r } = l[e];
              "window" === s
                ? i.matchMedia(`(min-width: ${r}px)`).matches && (t = z)
                : r <= a.clientWidth && (t = z);
            }
            return t || "max";
          }
      ...
      classes: {
        addClasses: function () {
          const { classNames: e, params: t, rtl: s, el: a, device: i } = this,
            r = (function (e, s) {
              const a = [];
              return (
                e.forEach((t) => {
          ...
          e.push(...r), a.classList.add(...e), this.emitContainerClasses();
        },
  ...
  class b {
    constructor() {
      let t, s;
      for (var m, e = arguments.length, a = new Array(e), i = 0; i < e; i++)
        a[i] = arguments[i];
      1 === a.length &&
      a[0].constructor &&
      ...
      if (
        s.el &&
        "string" == typeof s.el &&
        1 < r.querySelectorAll(s.el).length
      ) {
        const t = [];
        return (
          r.querySelectorAll(s.el).forEach((e) => {
            e = h({}, s, { el: e });
            t.push(new b(e));
          }),
          t
      ...
      const l = this,
        n =
          ...
          (l.support = Y()),
          (l.device =
            (void 0 === (m = { userAgent: s.userAgent }) && (m = {}),
            (p =
              p ||
              (function () {
                var e = (void 0 === m ? {} : m)["userAgent"];
                const t = Y(),
                  s = z(),
    ...
    getSlideIndex(e) {
      var { slidesEl: t, params: s } = this,
        t = x(I(t, `.${s.slideClass}, swiper-slide`)[0]);
      return x(e) - t;
    }
    ...
    recalcSlides() {
      ...
      this.slides = I(e, `.${t.slideClass}, swiper-slide`);
    }
    enable() {
      var e = this;
      e.enabled ||
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        let t,
          s = a[n] ? a[n].swiperSlideSize : 0;
        for (let e = n + 1; e < a.length; e += 1)
          a[e] &&
            !t &&
            ((s += a[e].swiperSlideSize), (o += 1), s > l && (t = !0));
        for (let e = n - 1; 0 <= e; --e)
          a[e] &&
            !t &&
            ((s += a[e].swiperSlideSize), (o += 1), s > l && (t = !0));
    ...
    mount(s) {
      ...
      if (!a.mounted) {
        ...
        if (!(e = "string" == typeof e ? document.querySelector(e) : e))
          return !1;
        (e.swiper = a), e.shadowEl && (a.isElement = !0);
        const i = () =>
        ...
        !t &&
          ...
          ((t = k("div", a.params.wrapperClass)),
          e.append(t),
          I(e, "." + a.params.slideClass).forEach((e) => {
            t.append(e);
          })),
          Object.assign(a, {
            el: e,
            wrapperEl: t,
            slidesEl: a.isElement ? e : t,
            mounted: !0,
            rtl: "rtl" === e.dir.toLowerCase() || "rtl" === D(e, "direction"),
            rtlTranslate:
              "horizontal" === a.params.direction &&
              ("rtl" === e.dir.toLowerCase() || "rtl" === D(e, "direction")),
            wrongRTL: "-webkit-box" === D(t, "display"),
          });
      }
      return !0;
    }
    ...
    return (
      s.params.createElements &&
        Object.keys(r).forEach((t) => {
          if (!i[t] && !0 === i.auto) {
            let e = I(s.el, "." + r[t])[0];
            e || (((e = k("div", r[t])).className = r[t]), s.el.append(e)),
              (i[t] = e),
              (a[t] = e);
          }
        }),
  ...
  function X(e, t, s) {
    ...
    return (
      r ||
        ((r = k("div", "swiper-slide-shadow" + (s ? "-" + s : ""))),
        i.append(r)),
      r
    );
  }
  return (
        ...
        t({ observer: !1, observeParents: !1, observeSlideChildren: !1 }),
          s("init", () => {
            if (a.params.observer) {
              ...
              r(a.el, { childList: a.params.observeSlideChildren }),
                r(a.wrapperEl, { attributes: !1 });
            }
          }),
          s("destroy", () => {
            l.forEach((e) => {
    ...
    b.use([
      function (e) {
        let t,
          { swiper: T, extendParams: s, on: a, emit: M } = e;
        s({
          virtual: {
            enabled: !1,
            slides: [],
        ...
        function C(e, t) {
          ...
          return (
            s.renderSlide
              ? "string" == typeof (a = s.renderSlide.call(T, e, t)) &&
        ...
        function l(t) {
          const {
            ...
            { from: n, to: o, slides: d, slidesGrid: p, offset: c } = T.virtual;
          ...
          let m,
            ...
            v =
              ...
              u -
                (f = a
                  ? ((h = Math.floor(s / 2) + e + l), Math.floor(s / 2) + e + r)
                  : ((h = s + (e - 1) + l), (i ? s : e) + r))),
            g = u + h,
            w =
              (i || ((v = Math.max(v, 0)), (g = Math.min(g, d.length - 1))),
              (T.slidesGrid[v] || 0) - (T.slidesGrid[0] || 0));
          function b() {
            T.updateSlides(),
              T.updateProgress(),
              T.updateSlidesClasses(),
          ...
          if (
            (i && u >= f
              ? ((v -= f), a || (w += T.slidesGrid[0]))
              : i && u < f && ((v = -f), a && (w += T.slidesGrid[0])),
            ...
            if (T.params.virtual.renderExternal)
              ...
              if (t)
                T.slidesEl
                  .querySelectorAll(`.${T.params.slideClass}, swiper-slide`)
                  .forEach((e) => {
                    e.remove();
                  });
              else
                for (let e = n; e <= o; e += 1)
                  if (e < v || e > g) {
                    ...
                    T.slidesEl
                      .querySelectorAll(
                        `.${T.params.slideClass}[data-swiper-slide-index="${s}"], swiper-slide[data-swiper-slide-index="${s}"]`
                      )
                      .forEach((e) => {
                        e.remove();
                      });
              ...
              var u = i ? -d.length : 0,
                y = i ? 2 * d.length : d.length;
              for (let e = u; e < y; e += 1)
                if (e >= v && e <= g) {
                  const T = S(e);
                  void 0 === o || t
                    ? x.push(T)
                    : (e > o && x.push(T), e < n && E.push(T));
                }
              if (
                (x.forEach((e) => {
              ...
              I(T.slidesEl, ".swiper-slide, swiper-slide").forEach((e) => {
        ...
        a("beforeInit", () => {
          if (T.params.virtual.enabled) {
            ...
            if (void 0 === T.passedParams.virtual.slides) {
              const t = [...T.slidesEl.children].filter((e) =>
            ...
            prependSlide: function (a) {
              ...
              if (Array.isArray(a)) {
                for (let e = 0; e < a.length; e += 1)
                  a[e] && T.virtual.slides.unshift(a[e]);
      ...
      function (e) {
          ...
          if (c.enabled) {
            ...
            if (
              ...
              if (
                ...
                let t = !1;
                if (
                  0 < G(c.el, `.${c.params.slideClass}, swiper-slide`).length &&
                  0 === G(c.el, "." + c.params.slideActiveClass).length
                )
                  return;
                const e = c.el,
                  a = e.clientWidth,
              ...
              c.isHorizontal()
                ? ((r || l || n || o) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
                  (((l || o) && !s) || ((r || n) && s)) && c.slideNext(),
                  (((r || n) && !s) || ((l || o) && s)) && c.slidePrev())
                : ((r || l || d || p) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
        ...
        function i() {
          c.keyboard.enabled ||
            (m.addEventListener("keydown", a), (c.keyboard.enabled = !0));
        }
        function r() {
          c.keyboard.enabled &&
            (m.removeEventListener("keydown", a), (c.keyboard.enabled = !1));
        }
      ...
      function (e) {
        ...
        function n(a) {
          ...
          if (
            p.enabled &&
            !a.target.closest("." + p.params.mousewheel.noMousewheelClass)
          ) {
            var l = p.params.mousewheel;
            ...
            if (0 === s) return !0;
            l.invert && (s = -s);
            let t = p.getTranslate() + s * l.sensitivity;
            if (
              ((t = t >= p.minTranslate() ? p.minTranslate() : t) <=
                p.maxTranslate() && (t = p.maxTranslate()),
              (r =
                !!p.params.loop ||
                !(t === p.minTranslate() || t === p.maxTranslate())) &&
                p.params.nested &&
                i.stopPropagation(),
              ...
              if (!r) {
                m = void 0;
                let e = p.getTranslate() + s * l.sensitivity;
                const t = p.isBeginning,
                  d = p.isEnd;
                if (
                  ...
                  if (
                    (h.push(a),
                    i && (a.delta > i.delta || a.direction !== i.direction))
                  )
                    h.splice(0);
                  else if (
                    15 <= h.length &&
                    ...
                    (m = a),
                      h.splice(0),
                      (u = T(() => {
                        p.slideToClosest(p.params.speed, !0, void 0, i);
                      }, 0));
                  }
                  u =
                    u ||
      ...
      function (e) {
        ...
        const l = (e) => (e = Array.isArray(e) ? e : [e].filter((e) => !!e));
        function n(e) {
          let t;
          return !(
            e &&
            "string" == typeof e &&
            i.isElement &&
            (t = i.el.shadowRoot.querySelector(e))
          ) &&
            (e &&
          ...
          (e = l(e)).forEach((e) => {
            e &&
              ...
              i.params.watchOverflow &&
                i.enabled &&
                e.classList[i.isLocked ? "add" : "remove"](s.lockClass));
          });
        }
        function o() {
          ...
          i.params.loop
            ? (a(t, !1), a(e, !1))
            : (a(t, i.isBeginning && !i.params.rewind),
        ...
        function c() {
          ...
          if (
            ...
            let e = n(s.nextEl),
              t = n(s.prevEl);
            Object.assign(i.navigation, { nextEl: e, prevEl: t }),
              (e = l(e)),
              (t = l(t));
            const a = (e, t) => {
      ...
      function (e) {
        ...
        let c,
          u =
            ...
            0);
        const m = (e) => (e = Array.isArray(e) ? e : [e].filter((e) => !!e));
        function r() {
          return (
        ...
        function a(e) {
          const t = e.target.closest(S(d.params.pagination.bulletClass));
          if (t) {
            e.preventDefault();
            var s = x(t) * d.params.slidesPerGroup;
            if (d.params.loop) {
              if (d.realIndex !== s) {
                const e = d.getSlideIndexByData(s),
                  t = d.getSlideIndexByData(d.realIndex);
                e > d.slides.length - d.loopedSlides &&
                  d.loopFix({
        ...
        function i() {
          ...
          if (!r()) {
            let r,
              ...
              t = d.pagination.el;
            t = m(t);
            const s = (d.virtual && d.params.virtual.enabled ? d.virtual : d)
                .slides.length,
              o = d.params.loop
                ? Math.ceil(s / d.params.slidesPerGroup)
                : d.snapGrid.length;
            if (
              (d.params.loop
              ...
              const p = d.pagination.bullets;
              let s, a, i;
              if (
                (n.dynamicBullets &&
                  ((c = H(p[0], d.isHorizontal() ? "width" : "height", !0)),
                  t.forEach((e) => {
                  ...
                  1 < n.dynamicMainBullets &&
                    void 0 !== e &&
                    ((u += r - (e || 0)) > n.dynamicMainBullets - 1
                      ? (u = n.dynamicMainBullets - 1)
                      : u < 0 && (u = 0)),
                  (s = Math.max(r - u, 0)),
                  (a = s + (Math.min(p.length, n.dynamicMainBullets) - 1)),
                  (i = (a + s) / 2)),
                p.forEach((e) => {
                  var t = [
                    ...[
                ...
                const l = p[r];
                if (
                  (l && l.classList.add(...n.bulletActiveClass.split(" ")),
                  d.isElement &&
                    p.forEach((e, t) => {
                      e.setAttribute(
                        "part",
              ...
              if (n.dynamicBullets) {
                const e = Math.min(p.length, n.dynamicMainBullets + 4),
                  t = (c * e - c) / 2 - i * c,
                  u = l ? "right" : "left";
                p.forEach((e) => {
            ...
            t.forEach((e, a) => {
              if (
                ("fraction" === n.type &&
                  (e.querySelectorAll(S(n.currentClass)).forEach((e) => {
                    e.textContent = n.formatFractionCurrent(r + 1);
                  }),
                  e.querySelectorAll(S(n.totalClass)).forEach((e) => {
                    e.textContent = n.formatFractionTotal(o);
                  })),
                "progressbar" === n.type)
              ) {
                var i = n.progressbarOpposite
                  ? d.isHorizontal()
                    ? "vertical"
                    : "horizontal"
                  : d.isHorizontal()
                ...
                let t = 1,
                  s = 1;
                "horizontal" == i ? (t = a) : (s = a),
                  e.querySelectorAll(S(n.progressbarFillClass)).forEach((e) => {
              ...
              "custom" === n.type && n.renderCustom
                ? ((e.innerHTML = n.renderCustom(d, r + 1, o)),
                  0 === a && p("paginationRender", e))
                : (0 === a && p("paginationRender", e),
                  p("paginationUpdate", e)),
        ...
        function l() {
          ...
          if (!r()) {
            var i = (d.virtual && d.params.virtual.enabled ? d.virtual : d)
              .slides.length;
                ...
                "custom" !== a.type && (e.innerHTML = s || ""),
                  "bullets" === a.type &&
                    d.pagination.bullets.push(
                      ...e.querySelectorAll(S(a.bulletClass))
                    );
              }),
              "custom" !== a.type && p("paginationRender", e[0]);
          }
        }
        function n() {
          ...
          if (t.el) {
            ...
            (e =
              (e =
                (e =
                  "string" == typeof t.el && d.isElement
                    ? d.el.shadowRoot.querySelector(t.el)
              ...
              (d.params.uniqueNavElements &&
                ...
                (e = e.filter((e) => G(e, ".swiper")[0] === d.el)[0]),
            ...
            e &&
              (e = m(e)).forEach((e) => {
                e.classList.remove(t.hiddenClass),
                  ...
                  t.clickable && e.removeEventListener("click", a);
              }),
              d.pagination.bullets &&
          ...
          s("click", (e, t) => {
            ...
            if (
              ...
              d.params.pagination.el &&
                ...
                a &&
                0 < a.length &&
                !s.classList.contains(d.params.pagination.bulletClass) &&
                (!d.navigation ||
                  !(
      ...
      function (e) {
        ...
        function i() {
          if (o.params.scrollbar.el && o.scrollbar.el) {
            const { scrollbar: s, rtlTranslate: a } = o,
              { dragEl: i, el: r } = s,
        ...
        function w(e) {
          const { scrollbar: t, wrapperEl: s } = o,
            { el: a, dragEl: i } = t;
          u &&
        ...
        function y(e) {
          var { scrollbar: t, params: s } = o,
            t = t.el;
          if (t) {
            const a = t,
              i = !!s.passiveListeners && { passive: !1, capture: !1 },
              r = !!s.passiveListeners && { passive: !0, capture: !1 };
            a &&
              ((t = "on" === e ? "addEventListener" : "removeEventListener"),
              a[t]("pointerdown", g, i),
              n[t]("pointermove", w, i),
              n[t]("pointerup", b, r));
          }
            ...
            (e =
              (e =
                "string" == typeof i.el && o.isElement
                  ? o.el.shadowRoot.querySelector(i.el)
                  : e) || "string" != typeof i.el
                ? e || i.el
                : n.querySelectorAll(i.el)),
              (e =
                0 <
                (e =
                  ...
                  "string" == typeof i.el &&
                  1 < e.length &&
                  1 === a.querySelectorAll(i.el).length
                    ? a.querySelector(i.el)
                    : e).length
                  ? e[0]
                  : e).classList.add(
              ...
              e &&
                ((t = e.querySelector("." + o.params.scrollbar.dragClass)) ||
                  ((t = k("div", o.params.scrollbar.dragClass)), e.append(t))),
              Object.assign(s, { el: e, dragEl: t }),
      ...
      function (e) {
        ...
        const r = (e, t) => {
            ...
            if (
              ...
              const p = n - (n - 1) * (1 - Math.abs(t));
              e.style.opacity = p;
            }
            let d = `translate3d(${i}, ${r}, 0px)`;
            null != l && (d += ` scale(${l - (l - 1) * (1 - Math.abs(t))})`),
      ...
      function (e) {
        ...
        function u(t) {
          if (("mouse" === t.pointerType && n.splice(0, n.length), c(t))) {
            var s = x.params.zoom;
            if (((i = !1), (r = !1), n.push(t), !(n.length < 2))) {
              if (((i = !0), (M.scaleStart = p()), !M.slideEl)) {
                ...
                if (
                  ...
                  (M.imageEl = e),
                  (M.imageWrapEl = e
                    ? G(M.imageEl, "." + s.containerClass)[0]
                    : void 0),
                  !M.imageWrapEl)
                )
                ...
                const [t, x] =
                  n.length < 2
                    ...
                    : ((s = M.imageEl.getBoundingClientRect()),
                      [
                        (n[0].pageX + (n[1].pageX - n[0].pageX) / 2 - s.x) / T,
                        (n[0].pageY + (n[1].pageY - n[0].pageY) / 2 - s.y) / T,
                      ]);
                (M.originX = t),
                  (M.originY = x),
        ...
        function m(t) {
          if (c(t)) {
            const e = x.params.zoom,
              s = x.zoom,
              a = n.findIndex((e) => e.pointerId === t.pointerId);
            0 <= a && (n[a] = t),
              n.length < 2 ||
                ((r = !0),
                (M.scaleMove = p()),
                M.imageEl &&
                  ((s.scale = (M.scaleMove / M.scaleStart) * T),
                  s.scale > M.maxRatio &&
                    (s.scale =
                      M.maxRatio - 1 + (s.scale - M.maxRatio + 1) ** 0.5),
                  s.scale < e.minRatio &&
                    (s.scale =
                      e.minRatio + 1 - (e.minRatio - s.scale + 1) ** 0.5),
                  (M.imageEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`)));
          }
        }
        function h(t) {
          if (c(t) && ("mouse" !== t.pointerType || "pointerout" !== t.type)) {
            const e = x.params.zoom,
              s = x.zoom,
              a = n.findIndex((e) => e.pointerId === t.pointerId);
            0 <= a && n.splice(a, 1),
        ...
        function f(e) {
          if (
            c(e) &&
            ((t = e),
            (s = "." + x.params.zoom.containerClass),
            t.target.matches(s) ||
              0 <
                [...x.el.querySelectorAll(s)].filter((e) =>
                  e.contains(t.target)
                ).length)
          ) {
            var t,
            ...
            if (M.imageEl && C.isTouched && M.slideEl) {
              C.isMoved ||
                ((C.width = M.imageEl.offsetWidth),
                (C.height = M.imageEl.offsetHeight),
                (C.startX = A(M.imageWrapEl, "x") || 0),
                (C.startY = A(M.imageWrapEl, "y") || 0),
                (M.slideWidth = M.slideEl.offsetWidth),
                (M.slideHeight = M.slideEl.offsetHeight),
                (M.imageWrapEl.style.transitionDuration = "0ms"));
              var a = C.width * s.scale,
                i = C.height * s.scale;
              if (!(a < M.slideWidth && i < M.slideHeight)) {
                if (
                  ((C.minX = Math.min(M.slideWidth / 2 - a / 2, 0)),
                  (C.maxX = -C.minX),
                ...
                e.cancelable && e.preventDefault(),
                  e.stopPropagation(),
                  (C.isMoved = !0);
                var a = (s.scale - T) / (M.maxRatio - x.params.zoom.minRatio),
                ...
                (C.currentX =
                  ...
                  (o.y =
                    ...
                    (Date.now() - o.prevTime) /
                    2),
                  Math.abs(C.touchesCurrent.x - o.prevPositionX) < 2 &&
                    (o.x = 0),
                  Math.abs(C.touchesCurrent.y - o.prevPositionY) < 2 &&
                    (o.y = 0),
        ...
        function g(w) {
          ...
          if (!M.slideEl) {
            ...
            (e =
              ...
              (M.imageEl = e),
              (M.imageWrapEl = e
                ? G(M.imageEl, "." + y.containerClass)[0]
                : void 0);
          }
          if (M.imageEl && M.imageWrapEl) {
            let e, t, s, a, i, r, l, n, o, d, p, c, u, m, h, f, v, g;
            x.params.cssMode &&
            ...
            1 === T && E && ((e = void 0), (t = void 0)),
              ...
              !w || (1 === T && E)
                ...
                : ((v = M.slideEl.offsetWidth),
                  ...
                  (s = O(M.slideEl).left + S.scrollX),
                  (a = O(M.slideEl).top + S.scrollY),
                  (i = s + v / 2 - e),
                  (r = a + g / 2 - t),
                  (o = M.imageEl.offsetWidth),
                  (d = M.imageEl.offsetHeight),
                  (p = o * b.scale),
                  (c = d * b.scale),
                  ...
                  (l = l < u ? u : l) > h && (l = h),
                  (n = n < m ? m : n) > f && (n = f)),
              E && 1 === b.scale && ((M.originX = 0), (M.originY = 0)),
        ...
        function w() {
          ...
          if (!M.slideEl) {
            x.params.virtual && x.params.virtual.enabled && x.virtual
              ? (M.slideEl = I(x.slidesEl, "." + x.params.slideActiveClass)[0])
              : (M.slideEl = x.slides[x.activeIndex]);
            ...
            (e =
              ...
              (M.imageEl = e),
              (M.imageWrapEl = e
                ? G(M.imageEl, "." + t.containerClass)[0]
                : void 0);
          }
          M.imageEl &&
            M.imageWrapEl &&
        ...
        function E() {
          ...
          if (!e.enabled) {
            ...
            x.wrapperEl.addEventListener("pointerdown", u, t),
              x.wrapperEl.addEventListener("pointermove", m, s),
        ...
        function P() {
          ...
          if (e.enabled) {
            e.enabled = !1;
            const { passiveListener: t, activeListenerWithCapture: s } = y();
            x.wrapperEl.removeEventListener("pointerdown", u, t),
              x.wrapperEl.removeEventListener("pointermove", m, s),
              ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
        ...
        Object.defineProperty(x.zoom, "scale", {
          ...
          set(e) {
            var t, s;
            d !== e &&
              ((t = M.imageEl), (s = M.slideEl), a("zoomChange", e, t, s)),
              (d = e);
          },
        }),
          s("init", () => {
          ...
          s("touchStart", (e, t) => {
            ...
            x.zoom.enabled &&
              ...
              M.imageEl &&
                ...
                (C.isTouched = !0),
                (s = 0 < n.length ? n[0] : t),
                (C.touchesStart.x = s.pageX),
                (C.touchesStart.y = s.pageY)));
          }),
          s("touchEnd", (e, t) => {
            if (x.zoom.enabled) {
              var s = x.zoom;
        ...
        t({ controller: { control: void 0, inverse: !1, by: "slide" } }),
          ...
          s("setTranslate", (e, t, s) => {
            n.controller.control &&
              ...
              n.controller.setTranslate(t, s);
          }),
          s("setTransition", (e, t, s) => {
            n.controller.control &&
              !n.controller.control.destroyed &&
              n.controller.setTransition(t, s);
          }),
                ...
                e.destroyed ||
                  ...
                  "slide" === n.params.controller.by &&
                    ...
                    (n.controller.spline = n.params.loop
                      ? new o(n.slidesGrid, s.slidesGrid)
                      : new o(n.snapGrid, s.snapGrid)),
      ...
      function (e) {
        ...
        const c = (e) => (e = Array.isArray(e) ? e : [e].filter((e) => !!e));
        function i(e) {
          (e = c(e)).forEach((e) => {
        ...
        function h(e) {
          if (13 === e.keyCode || 32 === e.keyCode) {
            ...
            (d.pagination &&
              d.pagination.el &&
              (s === d.pagination.el || d.pagination.el.contains(e.target)) &&
              !e.target.matches(S(d.params.pagination.bulletClass))) ||
              (d.navigation &&
                d.navigation.nextEl &&
                s === d.navigation.nextEl &&
                ((d.isEnd && !d.params.loop) || d.slideNext(),
                d.isEnd ? a(t.lastSlideMessage) : a(t.nextSlideMessage)),
              d.navigation &&
                d.navigation.prevEl &&
                s === d.navigation.prevEl &&
                ((d.isBeginning && !d.params.loop) || d.slidePrev(),
                d.isBeginning ? a(t.firstSlideMessage) : a(t.prevSlideMessage)),
              d.pagination &&
                s.matches(S(d.params.pagination.bulletClass)) &&
                s.click());
          }
        }
        function f() {
          return (
            d.pagination && d.pagination.bullets && d.pagination.bullets.length
          );
        }
        function v() {
          ...
          y = (e) => {
            ...
            d.a11y.clicked ||
              ((t = e.target.closest(
                ...
                d.slides.includes(t) &&
                ((s = d.slides.indexOf(t) === d.activeIndex),
                (a =
            ...
            const s = d.params.a11y,
              a =
                (s.itemRoleDescriptionMessage &&
                  u(d.slides, s.itemRoleDescriptionMessage),
                s.slideRole && l(d.slides, s.slideRole),
                d.slides.length);
            s.slideLabelMessage &&
        ...
        s("beforeInit", () => {
          (p = k("span", d.params.a11y.notificationClass)).setAttribute(
            "aria-live",
            "assertive"
          ),
          ...
          s("afterInit", () => {
            if (d.params.a11y.enabled) {
              const l = d.params.a11y;
              (d.isElement ? d.el.shadowEl : d.el).append(p);
              var s = d.el;
              l.containerRoleDescriptionMessage &&
                u(s, l.containerRoleDescriptionMessage),
                l.containerMessage && m(s, l.containerMessage);
              const n = d.wrapperEl,
                o =
                  l.id ||
                  n.getAttribute("id") ||
              ...
              var a,
                i,
                s =
                  d.params.autoplay && d.params.autoplay.enabled
                    ? "off"
                    : "polite",
                r = o;
              c(n).forEach((e) => {
              ...
              (e = c(e)),
                (t = c(t)),
                e && e.forEach((e) => g(e, o, l.nextSlideMessage)),
                t && t.forEach((e) => g(e, o, l.prevSlideMessage)),
                v() &&
                ...
                d.el.addEventListener("pointerdown", w, !0),
          ...
          s("fromEdge toEdge afterInit lock unlock", () => {
            ...
            d.params.a11y.enabled &&
              ...
              !d.params.rewind &&
              d.navigation &&
              (({ nextEl: e, prevEl: t } = d.navigation),
              t && (d.isBeginning ? (n(t), r) : (o(t), i))(t),
              e && (d.isEnd ? (n(e), r) : (o(e), i))(e));
          }),
          s("paginationUpdate", () => {
            if (d.params.a11y.enabled) {
              const t = d.params.a11y;
              f() &&
                d.pagination.bullets.forEach((e) => {
                  d.params.pagination.clickable &&
                    ...
                    e.matches(S(d.params.pagination.bulletActiveClass))
          ...
          s("destroy", () => {
            if (d.params.a11y.enabled) {
              ...
              (e = c(e)),
                ...
                d.el.removeEventListener("pointerdown", w, !0),
      ...
      function (e) {
        ...
        s("init", () => {
          if (l.params.history.enabled) {
            const e = z();
            l.params.history &&
              (e.history && e.history.pushState
                ? ((n = !0),
                  ((a = i(l.params.url)).key || a.value) &&
                    d(0, a.value, l.params.runCallbacksOnInit),
                  l.params.history.replaceState ||
            ...
            (t({
              hashNavigation: {
                ...
                getSlideIndex(e, t) {
                  ...
                  return s.getSlideIndex(
                    I(
                      s.slidesEl,
                      `.${s.params.slideClass}[data-hash="${t}"], swiper-slide[data-hash="${t}"]`
                    )[0]
                  );
                },
              },
              ...
              const e = l.location.hash.replace("#", ""),
                t =
                  s.virtual && s.params.virtual.enabled
                    ? s.slidesEl.querySelector(
                        `[data-swiper-slide-index="${s.activeIndex}"]`
                      )
          ...
          d = () => {
            if (r && s.params.hashNavigation.enabled) {
              ...
              n.history.replaceState
                ? n.history.replaceState(null, null, "#" + t || "")
                : (l.location.hash = t || ""),
                a("hashSet");
            }
          };
        i("init", () => {
          ...
          !s.params.hashNavigation.enabled ||
            ...
            (e = l.location.hash.replace("#", "")) &&
              ((e = s.params.hashNavigation.getSlideIndex(s, e)),
      ...
      function (e) {
        let r,
          l,
          { swiper: n, extendParams: t, on: s, emit: o, params: a } = e;
        ...
        function w(e) {
          n &&
            ...
            (n.wrapperEl.removeEventListener("transitionend", w), T());
        }
        const b = () => {
            var e;
            !n.destroyed &&
              n.autoplay.running &&
              (n.autoplay.paused ? (i = !0) : i && ((v = d), (i = !1)),
              (e = n.autoplay.paused ? d : g + v - new Date().getTime()),
          ...
          y = (t) => {
            if (!n.destroyed && n.autoplay.running) {
              ...
              (f = n.params.autoplay.delay), (v = n.params.autoplay.delay);
              var s = (() => {
                let e;
                if (
                  (e =
          ...
          E = () => {
            (n.autoplay.running = !0), y(), o("autoplayStart");
          },
          x = () => {
          ...
          M = () => {
            ...
            !n.destroyed &&
              n.autoplay.running &&
              ("hidden" === (e = L()).visibilityState && ((h = !0), S(!0)),
        ...
        s("init", () => {
          n.params.autoplay.enabled &&
            (n.params.autoplay.pauseOnMouseEnter &&
              ...
              n.el.addEventListener("pointerleave", P)),
          ...
          s("beforeTransitionStart", (e, t, s) => {
            !n.destroyed &&
              n.autoplay.running &&
              (s || !n.params.autoplay.disableOnInteraction ? S(!0, !0) : x());
          }),
          s("sliderFirstMove", () => {
            !n.destroyed &&
              n.autoplay.running &&
          ...
          Object.assign(n.autoplay, { start: E, stop: x, pause: S, resume: T });
      },
      function (e) {
        ...
        function r() {
          ...
          if (e && !e.destroyed) {
            ...
            var t;
            (a &&
              a.classList.contains(o.params.thumbs.slideThumbActiveClass)) ||
              (null != s &&
                ((t = e.params.loop
                  ? parseInt(
                      e.clickedSlide.getAttribute("data-swiper-slide-index"),
        ...
        function n(a) {
          ...
          if (i && !i.destroyed) {
            ...
            if (
              ...
              for (let e = 0; e < t; e += 1)
                i.slides[o.realIndex + e] &&
                  i.slides[o.realIndex + e].classList.add(s);
            ...
            if (o.realIndex !== i.realIndex || n) {
              ...
              let t, s;
              if (i.params.loop) {
                const a = i.slides.filter(
                  (e) =>
                    e.getAttribute("data-swiper-slide-index") ===
                    "" + o.realIndex
                )[0];
                (t = i.slides.indexOf(a)),
                  (s = o.activeIndex > o.previousIndex ? "next" : "prev");
              } else
                (t = o.realIndex), (s = t > o.previousIndex ? "next" : "prev");
              n && (t += "next" === s ? l : -1 * l),
                i.visibleSlidesIndexes &&
                  ...
                  e = () => {
                    o.destroyed ||
                      (() => {
                        const t =
                          "string" == typeof s.swiper
                            ? a.querySelector(s.swiper)
                            : s.swiper;
                        if (t && t.swiper) (s.swiper = t.swiper), l(), n(!0);
                        else if (t) {
                          const a = (e) => {
                            (s.swiper = e.detail[0]),
                  ...
                  if (l < -u.minTranslate()) u.slideTo(u.activeIndex);
                    ...
                    if (n.freeMode.momentum) {
                      ...
                      if (s < u.maxTranslate())
                        ...
                        s = -(s =
                          Math.abs(p[t] - s) < Math.abs(p[t - 1] - s) ||
                      ...
                      if (
                        ...
                        if (
                          ...
                          const l = Math.abs((d ? -s : s) - u.translate),
      ...
      function (e) {
        ...
        h.grid = {
          ...
          updateSlide: (e, t, s, a) => {
            var i = h.params["slidesPerGroup"],
              r = f(),
              { rows: l, fill: n } = h.params.grid;
            let o, d, p;
            if ("row" === n && 1 < i) {
              const u = Math.floor(e / (i * l)),
                m = e - l * i * u,
                h = 0 === u ? i : Math.min(Math.ceil((s - u * l * i) / l), i);
              (p = Math.floor(m / h)),
                (o = (d = m - p * h + u * i) + (p * c) / l),
                (t.style.order = o);
            } else
            ...
            (t.row = p),
              (t.column = d),
              (t.style[a("margin-top")] = 0 !== p ? r && r + "px" : "");
          },
          updateWrapperSize: (s, a, e) => {
            var { centeredSlides: t, roundLengths: i } = h.params,
              r = f(),
              l = h.params.grid["rows"];
            if (
              ((h.virtualSize = (s + r) * c),
              (h.virtualSize = Math.ceil(h.virtualSize / l) - r),
              (h.wrapperEl.style[e("width")] = h.virtualSize + r + "px"),
              t)
            ) {
              const s = [];
      ...
      function (e) {
        ...
        Object.assign(e, {
          ...
          addSlide: function (t, s) {
            const a = this,
              { params: i, activeIndex: e, slidesEl: r } = a;
            let l = e;
            i.loop &&
              ((l -= a.loopedSlides), a.loopDestroy(), a.recalcSlides());
            var n = a.slides.length;
            if (t <= 0) a.prependSlide(s);
            else if (n <= t) a.appendSlide(s);
            else {
              let e = l > t ? l + 1 : l;
              const o = [];
              for (let e = n - 1; e >= t; --e) {
          ...
          removeSlide: function (t) {
            ...
            if ("object" == typeof t && "length" in t)
              for (let e = 0; e < t.length; e += 1)
                (r = t[e]), s.slides[r] && s.slides[r].remove(), r < l && --l;
            else (r = t), s.slides[r] && s.slides[r].remove(), r < l && --l;
            (l = Math.max(l, 0)),
              s.recalcSlides(),
              e.loop && s.loopCreate(),
          ...
          m({
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < a.length; s += 1) {
                ...
                const i = l.params.fadeEffect.crossFade
      ...
      function (e) {
        let { swiper: v, extendParams: t, on: s } = e;
        t({
          cubeEffect: {
            slideShadows: !0,
            shadow: !0,
        ...
        const g = (e, t, s) => {
          ...
          a ||
            ((a = k("div", "swiper-slide-shadow-" + (s ? "left" : "top"))),
            e.append(a)),
            i ||
              ((i = k(
                "div",
        ...
        m({
          ...
          setTranslate: () => {
            const {
              ...
              u = v.isHorizontal(),
              m = v.virtual && v.params.virtual.enabled;
            let i,
              h = 0;
            c.shadow &&
              (u
                ? ((i = v.slidesEl.querySelector(".swiper-cube-shadow")) ||
                    ((i = k("div", "swiper-cube-shadow")),
                    v.slidesEl.append(i)),
                  (i.style.height = s + "px"))
                : (i = e.querySelector(".swiper-cube-shadow")) ||
                  ((i = k("div", "swiper-cube-shadow")), e.append(i)));
            for (let l = 0; l < n.length; l += 1) {
              ...
              const p = Math.max(Math.min(v.progress, 1), -1);
              let a = 0,
                i = 0,
                r = 0;
              e % 4 == 0
                ...
                o && (a = -a),
                u || ((i = a), (a = 0));
              var f = `rotateX(${u ? 0 : -t}deg) rotateY(${
                u ? t : 0
              }deg) translate3d(${a}px, ${i}px, ${r}px)`;
              p <= 1 &&
                -1 < p &&
                ((h = 90 * e + 90 * p), o && (h = 90 * -e - 90 * p)),
                (v.style.transform = f),
                c.slideShadows && g(v, p, u);
            }
            if (
              ...
              if (u)
                i.style.transform = `translate3d(0px, ${
                  s / 2 + c.shadowOffset
                ...
                const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                  ...
                  n = c.shadowScale / v,
                  g = c.shadowOffset;
                i.style.transform = `scale3d(${t}, 1, ${n}) translate3d(0px, ${
                  a / 2 + g
                }px, ${-a / 2 / n}px) rotateX(-90deg)`;
              }
            var r =
              (p.isSafari || p.isWebView) && p.needPerspectiveFix ? -d / 2 : 0;
        ...
        const u = (e, t, s) => {
          let a = c.isHorizontal()
            ...
            i = c.isHorizontal()
              ? e.querySelector(".swiper-slide-shadow-right")
              : e.querySelector(".swiper-slide-shadow-bottom");
          (a = a || X(0, e, c.isHorizontal() ? "left" : "top")),
            (i = i || X(0, e, c.isHorizontal() ? "right" : "bottom")),
            a && (a.style.opacity = Math.max(-t, 0)),
            i && (i.style.opacity = Math.max(t, 0));
        };
        m({
          ...
          setTranslate: () => {
            ...
            for (let r = 0; r < l.length; r += 1) {
              ...
              c.isHorizontal()
                ...
                o.slideShadows && u(p, e);
              d = `translate3d(${a}px, ${i}px, 0px) rotateX(${s}deg) rotateY(${t}deg)`;
              E(0, p).style.transform = d;
            }
          },
          setTransition: (t) => {
            const e = c.slides.map((e) => n(e));
            e.forEach((e) => {
              (e.style.transitionDuration = t + "ms"),
                e
                  .querySelectorAll(
              ...
              C({ swiper: c, duration: t, transformElements: e });
          },
          recreateShadows: () => {
            c.params.flipEffect,
              c.slides.forEach((e) => {
          ...
          m({
            ...
            setTranslate: () => {
              ...
              for (let n = 0, e = d.length; n < e; n += 1) {
                ...
                if (
                  ((E(0, b).style.transform = g),
                  (b.style.zIndex = 1 - Math.abs(Math.round(w))),
                  c.slideShadows)
                ) {
                  let e = u
                  ...
                  (e = e || X(0, b, u ? "left" : "top")),
                    (t = t || X(0, b, u ? "right" : "bottom")),
          ...
          setTranslate: () => {
            ...
            for (let a = 0; a < i.length; a += 1) {
              const r = i[a],
                m = r.progress,
                h = Math.min(
                  Math.max(r.progress, -l.limitProgress),
                  l.limitProgress
                );
              let e = h;
              o ||
              ...
              (w.style.transform = d),
                (w.style.opacity = u),
                s.origin && (w.style.transformOrigin = s.origin);
            }
          },
          setTransition: (t) => {
      ...
      function (e) {
        ...
        t({
          ...
          m({
            ...
            on: s,
            setTranslate: () => {
              const { slides: n, activeIndex: o, rtlTranslate: d } = y,
              ...
              for (let l = 0; l < n.length; l += 1) {
                ...
                let a = 1,
                  i = -p.perSlideRotate * b,
                  r = p.perSlideOffset - 0.75 * Math.abs(b);
                var f =
      ...
      `);
                ...
                (g.style.zIndex = -Math.abs(Math.round(w)) + n.length),
                  (E(0, g).style.transform = f);
              }
            },
            setTransition: (t) => {
              ...
              e.forEach((e) => {
                ...
                C({ swiper: y, duration: t, transformElements: e });
            },
            perspective: () => !0,
            overwriteParams: () => ({
              watchSlidesProgress: !0,
