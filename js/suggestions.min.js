!(function (e, t) {
      ...
      return (
        t(i) &&
          ...
          m.each(i, function (t, i) {
            ...
            let a = k.splitTokens(k.split(r, e));
  ...
  let y = {
    ...
    v = {
      ...
      assign: function (e, t) {
        ...
        for (let n = Object(e), i = 1; i < arguments.length; i++) {
          let s = arguments[i];
          if (null != s)
            for (let o in s)
    ...
    k = {
      ...
      tokenize: function (e, t) {
        let n = m.compact(k.formatToken(e).split(C)),
          i = m.minus(n, t),
          s = m.minus(n, i);
    ...
    F = {
      matchByNormalizedQuery: function (e) {
        return function (t, n) {
          let i = k.normalize(t, e),
            s = [];
          return (
            m.each(n, function (n, o) {
              let r = n.value.toLowerCase();
              return (
      ...
      matchByFields: function (e) {
        return function (t, n) {
          let i = k.splitTokens(k.split(t)),
            s = [];
          return 1 === n.length &&
            (e &&
              m.each(e, function (e, t) {
                let i = v.getDeepValue(n[0], t),
  ...
  r.prototype = {
        ...
        0 == e(t.target).closest(".ui-menu-item").length &&
          V.delay(function () {
            e(document).one("mousedown", function (t) {
              let i = n.el.add(n.$wrapper).add(n.options.$helpers);
    ...
    bindWindowEvents: function () {
      let t = e.proxy(this.inferIsMobile, this);
    ...
    checkStatus: function () {
      ...
      s || (s = K[i] = B.ajax(t.getAjaxParams("status"))),
        s
          .done(function (n, i, s) {
            if (n.search) {
              let o = s.getResponseHeader("X-Plan");
        ...
        t.type.geoEnabled &&
          ...
          e.isPlainObject(n) || e.isArray(n)
            ...
            : (J || (J = e.ajax(t.getAjaxParams("iplocate/address"))),
              J.done(function (e) {
                let n = e && e.location && e.location.data;
                n && n.kladr_id
  ...
  let ee = {
    enrichSuggestion: function (t, n) {
      ...
      i.disableDropdown();
      let o = i.type.getEnrichmentQuery(t),
  ...
  let te = { width: "auto", floating: !1 },
    ne = {
      ...
      buildSuggestionHtml: function (e, t, n) {
        ...
        let s = this.makeSuggestionLabel(this.suggestions, e);
        s &&
          n.push(
            '<span class="' +
  ...
  let ie = { constraints: null, restrict_value: !1 },
    se = [
      "country_iso_code",
      "region_iso_code",
      "region_fias_id",
  ...
  let re = function (e, t) {
    ...
    let n = m.makeArray(e && (e.locations || e.restrictions));
  ...
  let ae = {
    ...
    constructConstraintsParams: function () {
      for (
        let e, t, n = this, i = [], s = n.constraints, o = {};
        B.isJqObject(s) &&
        (e = s.suggestions()) &&
      ...
      if (!i.triggering.Select) {
        ...
        (n = i.hasSameValues(s)),
          i.enrichSuggestion(s, t).done(function (s, o) {
            let a = B.extend({ hasBeenEnriched: o, hasSameValues: n }, t);
