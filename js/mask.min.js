    ...
    let n = function (b, d, e) {
      let c = {
        ...
        getRegexMask: function () {
          for (let a = [], b, c, e, t, f = 0; f < d.length; f++)
        ...
        calculateCaretPosition: function (a) {
          let d = c.getMasked(),
            h = c.getCaret();
          if (a !== d) {
            let e = b.data("mask-previus-caret-pos") || 0;
            d = d.length;
            let g = a.length,
              f = (a = 0),
              l = 0,
      ...
      l.init = function (g) {
        ...
        if (g) c.events(), c.val(c.getMasked());
          ...
          g = 0;
          for (let f = !0; g < d.length; g++) {
            let h = l.translation[d.charAt(g)];
            if (h && h.recursive) {
              f = !1;
              break;
            }
