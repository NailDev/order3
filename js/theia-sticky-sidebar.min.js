!(function (i) {
  i.fn.theiaStickySidebar = function (t) {
    ...
    function a(t, e) {
      t.initialized = !0;
      let o = i("#theia-sticky-sidebar-stylesheet-" + t.namespace);
      0 === o.length &&
        i("head").append(
          i(
        ...
        e.each(function () {
          ...
          if (
            ...
            let s = /(?:text|application)\/(?:x-)?(?:javascript|ecmascript)/i;
            a.sidebar
              .find("script")
              .filter(function (i, t) {
          ...
          let r = a.stickySidebar.offset().top,
            ...
            (a.onScroll = function (a) {
              if (a.stickySidebar.is(":visible")) {
                ...
                if (a.options.disableOnResponsiveLayouts) {
                  let s = a.sidebar.outerWidth(
                    "none" == a.sidebar.css("float")
                  );
                  if (s + 50 > a.container.width()) return void e();
                }
                let r = i(document).scrollTop(),
                  d = "static";
                if (
                  r >=
                  ...
                  let k = a.container.height() == a.stickySidebar.outerHeight();
                  d =
                    (k || y != h) &&
