!(function (e) {
  ...
  function (e, t, n) {
    ...
    e.exports = function u() {
      let e,
        ...
        y = !1;
      for (
        "boolean" == typeof s && ((y = s), (s = arguments[1] || {}), (h = 2)),
            ...
            return {
              delims: {
                ...
                mod:
                  "string" == typeof a
                    ? { name: a, val: a }
                    : { name: a.name || r.name, val: a.val || a.name || r.val },
              },
  ...
  function (e, t, n) {
    ...
    let o = {
      ...
      toArray: function (e) {
        for (let t = [], n = e.length, o = 0; o < n; o += 1) t.push(e[o]);
        return t;
      },
          ...
          Object.keys(e)
            .map(function (t) {
              ...
              return "\n.ya-share2__item_service_"
                ...
                .concat(t, ' .ya-share2__icon\n{\n    background-image: url("')
                .concat(
                  o.replace("fill='%23FFF'", "fill='%23000'"),
                  '");\n}\n'
                );
            })
            .join("")
    ...
    let i = {
      ...
      getMod: function (e, t) {
        for (let n = 0, r = e.classList.length; n < r; n += 1) {
          let a = o["default"].parse(e.classList[n]);
    ...
    function a(e) {
      ...
      try {
        (window["yaCounter".concat(e)] = new window.Ya.Metrika2({
          ...
          params: { shareVersion: 2, redesign: 1, curtain: 1 },
          triggerEvent: !0,
        })),
          t();
      } catch (n) {}
        ...
        (n = [
          {
            ...
            value: function () {
              let e,
                t,
                n = this;
              if (window.Ya && "Metrika2" in window.Ya) a(this._id);
              else {
                let r = (0, o.injectJs)("https://mc.yandex.ru/metrika/tag.js");
                (e = function () {
                  a(n._id, function () {
  ...
  function (e, t, n) {
      ...
      (t["default"] = function (e) {
        return function (t) {
          ...
          return (
            ...
            t.map(function (t) {
              let a = new r["default"](t, (0, o["default"])({ options: n }, e));
              return (
                a.isBare() ||
                  _ ||
    ...
    let p = new s["default"](window.document),
      _ = !1;
  },
  function (e, t, n) {
    "use strict";
      ...
      c = (function (e) {
        ...
        for (let a in e)
          if (Object.prototype.hasOwnProperty.call(e, a)) {
            let i = r ? Object.getOwnPropertyDescriptor(e, a) : null;
            i && (i.get || i.set)
    ...
    function k(e, t) {
      ...
      for (let n = 0, o = new Array(t); n < t; n++) o[n] = e[n];
      return o;
    }
    let w = [
        "ya-share2__popup_direction_top",
    ...
    let j = (function () {
      function e(t, n) {
        ...
        let p = this._options.get("theme.lang");
        this._i18n = this._options.get("i18n.".concat(p));
        let u = Boolean(a.asPopup);
        this._setMobileFlag(),
          this._setCopyFlag(),
          this._initLayout(o, c, u),
          this._bindEvents(i),
        ...
        (n = [
          {
            key: "_setMobileFlag",
            value: function () {
              let e = this._options.get("theme.forceCurtain"),
          ...
          },
          {
            ...
            value: function () {
              let e = l["default"].findInside(this._domNode, {
                block: "ya-share2",
                elem: "container",
              })[0];
              ...
              let t = this._options.get("theme.limit"),
          ...
          },
          {
            ...
            value: function (e) {
              if (0 !== e.length) {
                ...
                let n = l["default"].findInside(this._domNode, {
                  block: "ya-share2",
                ...
                let p = l["default"].findInside(this._domNode, {
                  block: "ya-share2",
                  elem: "popup-body",
                })[0];
                p &&
          ...
          },
          {
            ...
            value: function (e, t, n) {
              let o = this,
                ...
                a = this._options.get("theme.limit"),
                c = Boolean(
              ...
              let p = (0, u.prepareServicesList)(r, {
                limit: a,
                needExtendMessenger: c,
              });
              (this._services = p
                .filter(function (t) {
                  return e[t];
                ...
                .map(function (t) {
                  let n = function (e) {
                    ...
                    i = a[n("content.template")] || a["default"],
                    c = (0, s.buildUrl)(i, r);
                  return {
                    name: t,
          ...
          },
          {
            key: "_onBodyClick",
            value: function (e, t) {
              let n = p["default"].getTarget(t);
              if (
                -1 !== this._closingCrosses.indexOf(n) ||
                n.classList.contains("ya-share2__popup-overlay")
              )
                this._closePopup(t);
              else if (
                !Boolean(
                  l["default"].findOutside(n, {
                    block: "ya-share2",
                    elem: "popup-header",
                  })
                )
              ) {
                let o = l["default"].findOutside(n, {
                    block: "ya-share2",
                    elem: "container",
                  }),
          ...
          },
          {
            ...
            value: function () {
              ...
              this._copiedTooltip.classList.add(
                ...
                setTimeout(function () {
                  e._copiedTooltip.classList.remove(
                    "ya-share2__copied-tooltip_shown"
                  );
                }, 2e3);
            },
          },
          {
            ...
            value: function (e) {
              let t = this;
              if (this.canCopy) {
                let n = this._options.get("content.url");
                navigator.clipboard
                  .writeText(n)
                  .then(function () {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) this._morePopup.classList.toggle(t);
                ...
                n - o > 0 && n + o > window.innerHeight
                  ? this._morePopup.classList.toggle(w[0])
                  : this._morePopup.classList.toggle(w[1]);
              }
            },
          },
          {
            ...
            value: function () {
              let e = this._morePopup.getBoundingClientRect();
          ...
          },
          {
            ...
            value: function (e) {
              if (this._morePopupContainer) {
                let t = l["default"].findInside(this._domNode, {
                    block: "ya-share2",
                    elem: "item",
                    modName: "more",
                  })[0],
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              let r = l["default"].getMod(t, "service");
              if (r) {
                let a = this._services.filter(function (e) {
                  return e.name === r;
                })[0];
                if (
                  a &&
                  (this._options.get("hooks.onshare").call(this, a.name),
                  !this._isDestroyed())
                ) {
                  if (
                    ...
                    let i = l["default"].findInside(t, {
                      block: "ya-share2",
                      elem: "link",
                    })[0];
                    e.preventDefault(),
                      e.stopPropagation(),
                      c.open("ya-share2", i.href, a.popupDimensions);
                  }
                  let s = l["default"].findInside(this._domNode, {
                      block: "ya-share2",
                      elem: "item",
                    }),
                    p = [].indexOf.call(s, t);
          ...
          },
          {
            ...
            value: function () {
              this._morePopup.classList.toggle("ya-share2__popup_visible"),
                ...
                this.hasCurtain &&
                  (this.popupBody ||
                    (this.popupBody = l["default"].findInside(this._morePopup, {
                      block: "ya-share2",
                      elem: "popup-body",
                    })[0]),
          ...
          },
          {
            ...
            value: function (e) {
              if (
                this._morePopup &&
                this._morePopup.classList.contains("ya-share2__popup_visible")
              ) {
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    let o = t.value;
                    this._morePopup.classList.remove(o);
                  }
                } catch (c) {
                  n.e(c);
                } finally {
                ...
                if ("auto" === this._options.get("theme.popupDirection")) {
                  ...
                  try {
                    for (i.s(); !(r = i.n()).done; ) {
                      let s = r.value;
                      this._morePopup.classList.remove(s);
                    }
                  } catch (c) {
                    i.e(c);
                  } finally {
  ...
  function (e, t, n) {
    ...
    function o(e) {
      if (Array.isArray(e)) {
        for (let t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t];
        return n;
      }
      return Array.from(e);
    }
    ...
    let i =
      ...
      d = function () {
        setTimeout(function () {
          _ !== undefined &&
            ((document.body.style.paddingRight = _), (_ = undefined)),
            p !== undefined &&
              ((document.body.style.overflow = p), (p = undefined));
        });
      };
    t.disableBodyScroll = function (e, t) {
      if (i) {
        ...
        if (
          ...
          let n = { targetElement: e, options: t || {} };
          (s = [].concat(o(s), [n])),
            ...
            (e.ontouchmove = function (t) {
              1 === t.targetTouches.length &&
                (function (e, t) {
                  let n = e.targetTouches[0].clientY - l;
                  !u(e.target) &&
                    ((t && 0 === t.scrollTop && n > 0) ||
                    ((function (e) {
                      return (
        ...
        !(function (e) {
          setTimeout(function () {
            if (_ === undefined) {
              ...
              t &&
                n > 0 &&
                ((_ = document.body.style.paddingRight),
        ...
        let a = { targetElement: e, options: t || {} };
        s = [].concat(o(s), [a]);
      }
    };
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.initTemplates = function (e, t) {
        let n,
          _,
          d = { hasCurtain: t, i18n: e },
          y =
            (u((n = {}), h.elem, f(h.elem)),
            u(n, h.messengerContactsList, f(h.messengerContactsList)),
            u(n, h.popupTemplate, f(h.popupTemplate)),
            u(n, h.mElem, f(h.mElem)),
            u(n, h.mBody, f(h.mBody)),
            u(n, h.mContactsElem, f(h.mContactsElem)),
            n),
          m =
            (u((_ = {}), h.elem, (0, s.commonTemplates)(y, d)),
            u(
              _,
              h.messengerContactsList,
              (0, p.getMessengerContactsListTemplate)(y, d)
            ),
            u(_, h.popupTemplate, (0, i.getPopupTemplate)(y, d)),
            u(_, h.mElem, (0, a.mobileTemplates)(y, d)),
            u(_, h.mBody, (0, l.getMobileBody)(y, d)),
            u(_, h.mContactsElem, (0, c.mobileContactsTemplates)(y, d)),
            _);
        function f(e) {
          return function (t, n) {
            return (0, o["default"])(
  ...
  function (e, t, n) {
    ...
    let r = (function () {
      function e() {
        this._shortTags = {};
        for (let e = 0; e < t.length; e++) this._shortTags[t[e]] = 1;
                ...
                for (t in _)
                  !0 === (u = _[t])
                    ...
                    : !1 !== u &&
                      ...
                      (y += " " + t + '="' + r(u) + '"');
              if (p) {
                let f = e.block + (e.elem ? this._optDelimElem + e.elem : "");
                e.block &&
                  ((d = i(e, f, null, this._optNobaseMods, this._optDelimMod)),
                  e.js && ((h = {})[f] = !0 === e.js ? {} : e.js));
                let g = this._optJsCls && (this._optJsElem || !e.elem),
                  v = e.mix;
                if (v && v.length)
                  for (t = 0, s = v.length; t < s; t++) {
                    let b = v[t];
                    if (b && !1 !== b.bem) {
                      let k = b.block || e.block || "",
      ...
      (t.mobileTemplates = function (e, t) {
        ...
        return {
          ...
          "popup-content": function (e) {
            ...
            return {
              content: [
                i("popup-header", { customContent: o }),
                s("popup-body", {
                  services: t,
                  url: n,
                  copy: r,
          ...
          "popup-header": function (e) {
            ...
            if (!s) {
              let l =
                (0, a.getOgTag)("image:secure_url") || (0, a.getOgTag)("image");
            ...
            return {
              content: [
                ...
                i("popup-description", r),
                (0, o["default"])(n("icon"), { mods: { "closing-cross": !0 } }),
              ],
            };
          },
          "og-image": function (e) {
          ...
          "popup-tile": function (e) {
            let t = e.map(function (e) {
              ...
              o[
                "default"
              ])(n("item", e), { content: (0, o["default"])(n("link", e), { content: [i("mobile-popup-badge"), i("mobile-popup-service-title", e.title)] }) });
            });
            return (
          ...
          "native-share": function () {
            return (0, o["default"])(n("item", { name: "other" }), {
          ...
          "native-share-fake-link": function () {
            return {
              content: [
                (0, o["default"])(i("mobile-popup-badge"), {
                  mods: { "native-share": !0 },
                }),
          ...
          "mobile-popup-copy-link": function (e) {
            return {
              content: (0, o["default"])(n("item", e), {
                ...
                content: [
                  (0, o["default"])(n("icon"), { mods: { "copy-icon": !0 } }),
                  i("link-title"),
                  n("input_copy", e),
                ],
              }),
      ...
      (t.getPopupTemplate = function (e, t) {
        ...
        a.popup = r
          ...
          : function (e) {
              ...
              return (
                "first" === i && l
                  ? p.content[0].splice(1, 0, n("item_copy", r))
                  : "first" === i
                  ? p.content[0].unshift(n("item_copy", r))
                  : "last" === i && p.content[0].push(n("item_copy", r)),
                {
                  mods: {
                    direction: (s =
                      "top" === s ? "top" : "auto" === s ? "auto" : "bottom"),
                    "list-direction": (c =
  ...
  function (e, t, n) {
          ...
          list: function (e) {
            ...
            return {
              ...
              content: [
                ...
                0 === y.length && "extraItem" === s && n("item_copy", i),
                y.length > 0 &&
                  n("item_more", {
                    services: y,
                    url: i,
    ...
    function s(e) {
      for (let t = 1; t < arguments.length; t++) {
        let n = null != arguments[t] ? arguments[t] : {};
        t % 2
        ...
        let n = e.mElem,
          ...
          c = function (e) {
            let t = e.services,
              ...
              s = e.copy,
              c = [
                n("header", a.sendToMessenger),
                n("scroll-hider", o("messenger-contacts")),
                n("header", a.shareButton),
                n("scroll-hider", r("popup-tile-wrapper", t)),
              ];
          ...
          ? function (e) {
              return {
                ...
                content: e.map(function (e) {
                  ...
                  r[
                    "default"
                  ])(n("item", e), { content: (0, r["default"])(n("link", e), { content: [o("mobile-popup-badge", e.iconUrl), o("mobile-popup-service-title", e.title)] }) });
                }),
              };
            }
          : function (e) {
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.open = function (e, t, n) {
        let r = "".concat(e).concat(Date.now()),
          a =
            ((_ = n),
            (u = 2),
            (function (e) {
  ...
  function (e, t, n) {
    ...
    let u = (function () {
      function e() {
        p(this, e);
        for (let t = arguments.length, n = new Array(t), r = 0; r < t; r++)
          n[r] = arguments[r];
    ...
    function h(e, t) {
      let n = (0, o["default"])(!0, {}, e, { contentByService: {} });
      return (
        Object.keys(t).forEach(function (e) {
          let o = t[e];
          Object.keys(o).forEach(function (t) {
            let r = "contentByService.".concat(e, ".").concat(t),
              i = o[t];
            (0, a["default"])(n, r, i);
          });
        }),
              ...
              Object.keys(c).forEach(function (e) {
                ...
                "object" === s(i) &&
                  ...
                  Object.keys(o).forEach(function (i) {
                    ...
                    ((0, r["default"])(t, "content.".concat(i)) === undefined &&
                      (0, r["default"])(
                        t,
  ...
  function (e, t, n) {
    ...
    let o = n(16),
      r = n(19);
    e.exports = function (e, t) {
      for (let n = 0, a = (t = o(t, e)).length; null != e && n < a; )
        e = e[r(t[n++])];
  ...
  function (e, t, n) {
    "use strict";
    let o = n(10)["__core-js_shared__"];
    e.exports = o;
  },
  function (e, t, n) {
    "use strict";
    let o = Function.prototype.toString;
    e.exports = function (e) {
      if (null != e) {
        try {
          return o.call(e);
  ...
  function (e, t, n) {
    "use strict";
    e.exports = function (e, t) {
      for (let n = -1, o = null == e ? 0 : e.length, r = Array(o); ++n < o; )
        r[n] = t(e[n], n, e);
      return r;
    };
  },
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, c) {
      if (!i(e)) return e;
      for (
        let l = -1, p = (t = r(t, e)).length, _ = p - 1, u = e;
        null != u && ++l < p;
